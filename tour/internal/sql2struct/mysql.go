/*
 * @Author: ChZheng
 * @Date: 2021-12-26 22:20:55
 * @LastEditTime: 2021-12-27 01:20:02
 * @LastEditors: ChZheng
 * @Description:
 * @FilePath: /go-programming-tour-book/tour/internal/sql2struct/mysql.go
 */
package sql2struct
...
func (m *DBModel) GetColumns(dbName, tableName string) ([]*TableColumn, error) {
	query := "SELECT COLUMN_NAME, DATA_TYPE,COLUMN_KEY, " +
		"IS_NULLABLE, COLUMN_NAME, COLUMN_COMMENT " +
